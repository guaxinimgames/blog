...
var FB_APP_ID = "<?php echo get_field('fb_app_id','options') ?>";
  ...
  <div id="wrapper" class="container"><?php switch($layout){
    ...
    <main id="content" tabindex="-1" role="main" class="<?php echo $_class; ?>">
      <main id="content" tabindex="-1" role="main" class="<?php echo odin_classes_page_sidebar(); ?>"></main><?php while ( have_posts() ) : the_post(); ?><?php get_template_part( 'content', 'page' ); ?><?php if ( comments_open() || get_comments_number() ) : ?><?php comments_template(); ?><?php endif ?><?php endwhile ?>

...
<body <?php body_class(); ?>><a id="skippy" href="#content" class="sr-only sr-only-focusable">
  ...
  <div id="wrapper" class="container">
    <main id="content" tabindex="-1" role="main" class="<?php echo odin_classes_page_sidebar(); ?>"><?php if(have_posts()): ?><?php while ( have_posts() ) : the_post(); ?><?php get_template_part( 'content', get_post_format() ); ?><?php endwhile; ?><?php odin_paging_nav(); ?><?php else: ?><?php get_template_part( 'content', 'none' ); ?><?php endif ?>

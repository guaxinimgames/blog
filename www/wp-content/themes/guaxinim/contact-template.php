...
<head>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/pages/contact/contact.min.js"></script>
</head>
<body <?php body_class(); ?>><?php //Template Name: Contato ?><a id="skippy" href="#content" class="sr-only sr-only-focusable">
  ...
  <div id="wrapper" class="container">
    <main id="content" tabindex="-1" role="main" class="<?php echo odin_classes_page_sidebar(); ?>">
      <div class="contact-form"><?php echo odin_contact_form()->render(); ?>
      </div>

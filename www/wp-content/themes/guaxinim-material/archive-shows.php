<!DOCTYPE html><?php $taxonomy = 'shows_categories'; ?><?php $sub_header_items = isset($sub_header_items)? $sub_header_items : get_terms(array('taxonomy' => $taxonomy)); ?><?php $active_category = isset($active_category)? $active_category : $wp_query->get_queried_object(); ?>
<head>

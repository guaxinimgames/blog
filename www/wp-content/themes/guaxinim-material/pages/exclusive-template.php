...
foreach(wp_get_nav_menu_items('Main Menu') as $i=>$menu_item){
    ...
    <div class="main-container">
      <div class="main-content">
        ...
        </div><?php //Template Name: Exclusive ?><?php wp_reset_postdata(); ?><?php wp_reset_query(); ?><?php $header_class = (get_the_title() !== 'Home')? "internal-header" : ""; ?>
	...
	'menu_class' => 'nav navbar-nav text-center'
        ...
        <div id="wrapper">
          <main id="content" tabindex="-1" role="main">
            <h1 class="text-center">Acesse o conteúdo exclusivo</h1>
            <div class="col-md-12">
              <div class="content"></div>
              <div class="text"><?php echo $post->post_content	; ?></div>
              <div class="center-block"><a href="<?php echo get_field("button_link") ?>" target="_blank" class="btn"><?php echo get_field("button_text"); ?></a></div>
            </div>
            <div class="cf"></div>
          </main>
        </div>
